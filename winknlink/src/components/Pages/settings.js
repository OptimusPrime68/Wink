    ...
    <div>
        ...
        <div className="tabSettings">
          <section id="sectionId">
              ...
              <div className="col-md-6 mb-3">
                <div className="row">
                  ...
                  <Button variant="outlined" onClick={handleShow} >
                      {user.user == "free"?"Upgrade":"Already a Prime Member"}
                    </Button>
                  </div>
                </div>
              </div>
            ...
            <div className="" style={{ textAlign: "center" }}>
              <button className="SettingButton" type="button" onClick={handleUpdate}>
                Update
              </button>
            </div>
          </section>
      ...
      <Modal show={show} onHide={handleClose} centered>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={handlePayment} >Buy</Button>
        </Modal.Footer>
      </Modal>
    </div>
  );
